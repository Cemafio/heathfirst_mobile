...
class _PatientInscriptionState extends State<PatientInscription> {
  ...
  String _prenom = '';
  String _photo = '';
  String _roles = 'ROLE_PATIENT';
  String _medoc_en_cours = '';
  String _allergie = '';
  String _ant_medoc = '';
  String _tel = '';
  String _sexe = '';
  ...
  Future<void> inscriptionPatient(String nom,String prenom,String date_de_naissance,String photo,String sexe,String tel,String ant_medoc,String allergie,String  ident, String pass, String adress, String medoc_en_cours, String roles ) async {
    ...
    // request.fields['photo_profil'] = photo;
    request.fields['Sexe'] = sexe;
    request.fields['telephone'] = tel;
    request.fields['AntecedantMedicaux'] = ant_medoc;
    request.fields['Allergies'] = allergie;
    request.fields['MedicamentEnCours'] = medoc_en_cours;
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          if (isValide) {
                            ...
                            try {
                              await inscriptionPatient(  _nom,_prenom, _date_de_naissance, _photo, _sexe, _tel, _ant_medoc, _allergie,_identifiant, _pass, _adress,_medoc_en_cours, _roles);
