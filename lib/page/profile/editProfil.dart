...
class _EditprofilState extends State<Editprofil> {
  ...
  TextEditingController _antecMedocController = TextEditingController();
  TextEditingController _alegieController = TextEditingController();
  ...
  void _setInitialValue () {
    ...
    _networkImageUrl = "http://10.16.101.28:8000/images/photos/${_infoUser['photo_profil']}";
